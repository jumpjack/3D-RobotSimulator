...
function startingPlaceholderInit() {
    ...
    jitter_radius = 0.2;  // and this too
    ...
    my_object.course_number = 567;  // this is a number
...
function startingPlaceholderAnimate() {
    ...
    if (keyboard.pressed("x")) {
        ...
        textbar.innerHTML = "going down";  // make the pieces move down
        ...
        textbar.innerHTML = "Going to get scary!!";  // increase jittering the pieces
        jitter_radius += 0.1;
    }
    else if (keyboard.pressed("0")) {
        textbar.innerHTML = "relax!";  // decrease jittering the pieces
        jitter_radius -= 0.1;
    }
        ...
        // reset to intial
        textbar.innerHTML = "Resetting";  // set message text
        vert_offset = 1;
        jitter_radius = 0.2;
    }
    else{
        textbar.innerHTML = "Welcome to AutoBot Sim v1.0! You better beat the Decepticons! :P";  // set message text
    }
